...
required_patterns=(
  ...
  "tests/smoke/test-pilot-safety-ui-workflow.sh"
  "tests/smoke/test-pilot-safety-api-preview.sh"
  "tests/smoke/test-pilot-safety-api-execute.sh"
  ...
  "inspection by combining the focused UI and API smokes"
  "source-bound preview, execution posture, result, and audit surfaces"
  "preview persistence, source entitlement denial, and guard audit contract"
  "candidate-only execute, result inspection, cancellation, and audit history contract"
